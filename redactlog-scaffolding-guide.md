...
| A GitHub account | — | — |
| A GitHub repo created at `github.com/redactlog/redactlog` | empty | — |
...
```bash
go mod init github.com/redactlog/redactlog
```
...
```bash
cd bench
go mod init github.com/redactlog/redactlog/bench
...
Verify CI runs green at `github.com/redactlog/redactlog/actions`.
...
go list -m github.com/redactlog/redactlog@v0.0.1
```

Or visit [pkg.go.dev/github.com/redactlog/redactlog](https://pkg.go.dev/github.com/redactlog/redactlog) in a browser. If the page doesn't exist, click "Request" on pkg.go.dev to trigger a crawl.
...
pkgsite -http :6060
# then open http://localhost:6060/github.com/redactlog/redactlog
